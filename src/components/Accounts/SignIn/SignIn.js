      ...
      {(t, { lng }) => (
        <div className="row">
          ...
          <div className={`col-xs-12 col-sm-12 col-md-6 col-lg-5 ${styles.right}`}>
            ...
            <div className={`col-xs-12 col-offset-xs-2`}>
              {props.auth.error && (
                <div class="alert alert-danger" role="alert">
                  {props.auth.error.toString()}
                </div>
              )}
              <form className="form-group" onSubmit={onSubmit}>
                ...
                <button disabled={loading} type="submit" className={`${styles.button} ${styles.main}`}>
                  {!loading ? t('accounts.signin') : 'Loading...'}
                </button>
              </form>
